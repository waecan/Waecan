...
/// - Spend key: `HMAC-SHA512(b"waecan-spend-v1", seed)`
/// - View key:  `HMAC-SHA512(b"waecan-view-v1", seed)`
///
...
pub fn derive_keypairs(seed: &MasterSeed) -> Result<(SpendKeypair, ViewKeypair), CryptoError> {
    let spend = derive_single_keypair(seed, b"waecan-spend-v1")?;
    let view = derive_single_keypair(seed, b"waecan-view-v1")?;
    Ok((
        SpendKeypair {
            private: spend.0,
            public: spend.1,
